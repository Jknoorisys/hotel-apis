...
class ContentController extends Controller
{
    public function calculateSignature()
    {
        ...
        $publicKey = config('apitude.hotel.Api-key');
        $privateKey = config('apitude.hotel.secret');
    ...
    public function hotels(Request $request) {
        ...
        try {
            ...
            $response = Http::withHeaders([
                'Api-key' => config('apitude.hotel.Api-key'),
                'X-Signature' => $Signature,
                'Accept' => 'application/json',
                'Accept-Encoding' => 'gzip',
                'Content-Type' => 'application/json',
            ])->get(config('apitude.end-point').'/hotel-content-api/1.0/hotels?'. $queryString);
    ...
    public function hotelDetails(Request $request) {
        ...
        try {
            ...
            $response = Http::withHeaders([
                ...
                'Accept-Encoding' => 'gzip',
                'Content-Type' => 'application/json',
            ])->get(config('apitude.end-point').'/hotel-content-api/1.0/hotels/'.$hotelCodes.'/details?'. $queryString);
    ...
    public function countries(Request $request) {
        ...
        try {
            ...
            $response = Http::withHeaders([
                ...
                'Accept-Encoding' => 'gzip',
                'Content-Type' => 'application/json',
            ])->get(config('apitude.end-point').'/hotel-content-api/1.0/locations/countries?'. $queryString);
    ...
    public function destinations(Request $request) {
        ...
        try {
            ...
            $response = Http::withHeaders([
                ...
                'Accept-Encoding' => 'gzip',
                'Content-Type' => 'application/json',
            ])->get(config('apitude.end-point').'/hotel-content-api/1.0/locations/destinations?'. $queryString);
    ...
    public function accommodations(Request $request) {
        ...
        try {
            ...
            $response = Http::withHeaders([
                ...
                'Accept-Encoding' => 'gzip',
                'Content-Type' => 'application/json',
            ])->get(config('apitude.end-point').'/hotel-content-api/1.0/types/accommodations?'. $queryString);
    ...
    public function boards(Request $request) {
        ...
        try {
            ...
            $response = Http::withHeaders([
                ...
                'Accept-Encoding' => 'gzip',
                'Content-Type' => 'application/json',
            ])->get(config('apitude.end-point').'/hotel-content-api/1.0/types/boards?'. $queryString);
    ...
    public function categories(Request $request) {
        ...
        try {
            ...
            $response = Http::withHeaders([
                ...
                'Accept-Encoding' => 'gzip',
                'Content-Type' => 'application/json',
            ])->get(config('apitude.end-point').'/hotel-content-api/1.0/types/categories?'. $queryString);
    ...
    public function chains(Request $request) {
        ...
        try {
            ...
            $response = Http::withHeaders([
                ...
                'Accept-Encoding' => 'gzip',
                'Content-Type' => 'application/json',
            ])->get(config('apitude.end-point').'/hotel-content-api/1.0/types/chains?'. $queryString);
    ...
    public function currencies(Request $request) {
        ...
        try {
            ...
            $response = Http::withHeaders([
                ...
                'Accept-Encoding' => 'gzip',
                'Content-Type' => 'application/json',
            ])->get(config('apitude.end-point').'/hotel-content-api/1.0/types/currencies?'. $queryString);
    ...
    public function facilities(Request $request) {
        ...
        try {
            ...
            $response = Http::withHeaders([
                ...
                'Accept-Encoding' => 'gzip',
                'Content-Type' => 'application/json',
            ])->get(config('apitude.end-point').'/hotel-content-api/1.0/types/facilities?', $queryString);
    ...
    public function facilitygroups(Request $request) {
        ...
        try {
            ...
            $response = Http::withHeaders([
                ...
                'Accept-Encoding' => 'gzip',
                'Content-Type' => 'application/json',
            ])->get(config('apitude.end-point').'/hotel-content-api/1.0/types/facilitygroups?'. $queryString);
    ...
    public function facilitytypologies(Request $request) {
        ...
        try {
            ...
            $response = Http::withHeaders([
                ...
                'Accept-Encoding' => 'gzip',
                'Content-Type' => 'application/json',
            ])->get(config('apitude.end-point').'/hotel-content-api/1.0/types/facilitytypologies?', $queryString);
    ...
    public function issues(Request $request) {
        ...
        try {
            ...
            $response = Http::withHeaders([
                ...
                'Accept-Encoding' => 'gzip',
                'Content-Type' => 'application/json',
            ])->get(config('apitude.end-point').'/hotel-content-api/1.0/types/issues?', $queryString);
    ...
    public function languages(Request $request) {
        ...
        try {
            ...
            $response = Http::withHeaders([
                ...
                'Accept-Encoding' => 'gzip',
                'Content-Type' => 'application/json',
            ])->get(config('apitude.end-point').'/hotel-content-api/1.0/types/languages?', $queryString);
    ...
    public function promotions(Request $request) {
        ...
        try {
            ...
            $response = Http::withHeaders([
                ...
                'Accept-Encoding' => 'gzip',
                'Content-Type' => 'application/json',
            ])->get(config('apitude.end-point').'/hotel-content-api/1.0/types/promotions?'. $queryString);
    ...
    public function rooms(Request $request) {
        ...
        try {
            ...
            $response = Http::withHeaders([
                ...
                'Accept-Encoding' => 'gzip',
                'Content-Type' => 'application/json',
            ])->get(config('apitude.end-point').'/hotel-content-api/1.0/types/rooms?'. $queryString);
    ...
    public function segments(Request $request) {
        ...
        try {
            ...
            $response = Http::withHeaders([
                ...
                'Accept-Encoding' => 'gzip',
                'Content-Type' => 'application/json',
            ])->get(config('apitude.end-point').'/hotel-content-api/1.0/types/segments?'. $queryString);
    ...
    public function terminals(Request $request) {
        ...
        try {
            ...
            $response = Http::withHeaders([
                ...
                'Accept-Encoding' => 'gzip',
                'Content-Type' => 'application/json',
            ])->get(config('apitude.end-point').'/hotel-content-api/1.0/types/terminals?'. $queryString);
    ...
    public function imagetypes(Request $request) {
        ...
        try {
            ...
            $response = Http::withHeaders([
                ...
                'Accept-Encoding' => 'gzip',
                'Content-Type' => 'application/json',
            ])->get(config('apitude.end-point').'/hotel-content-api/1.0/types/imagetypes?'. $queryString);
    ...
    public function groupcategories(Request $request) {
        ...
        try {
            ...
            $response = Http::withHeaders([
                ...
                'Accept-Encoding' => 'gzip',
                'Content-Type' => 'application/json',
            ])->get(config('apitude.end-point').'/hotel-content-api/1.0/types/groupcategories?'. $queryString);
    ...
    public function ratecomments(Request $request) {
        ...
        try {
            ...
            $response = Http::withHeaders([
                ...
                'Accept-Encoding' => 'gzip',
                'Content-Type' => 'application/json',
            ])->get(config('apitude.end-point').'/hotel-content-api/1.0/types/ratecomments?'. $queryString);
    ...
    public function ratecommentdetails(Request $request) {
        ...
        try {
            ...
            $response = Http::withHeaders([
                ...
                'Accept-Encoding' => 'gzip',
                'Content-Type' => 'application/json',
            ])->get(config('apitude.end-point').'/hotel-content-api/1.0/types/ratecommentdetails?'. $queryString);
